      ...
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          ...
          <div>
            ...
            <p className="footer__desc">
              AI-assisted tools for fabric analysis, image search, and
        ...
        <div className="footer__cols">
          ...
          <div className="footer__col">
            ...
            <ul>
              <li>
                <Link to="/view">Uploaded Fabrics</Link>
              </li>
              <li>
                <Link to="/reader">Document Reader</Link>
              </li>
              <li>
